...
import MainHeroComponent from '@/components/landing/MainHeroComponent.vue';
...
<template>
    <main class="">
        <section class="mb-5" id="firstHero">
            <HeaderComponent class="component-header"></HeaderComponent>
            <MainHeroComponent class="component-body"></MainHeroComponent>
        </section>
