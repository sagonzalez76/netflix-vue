    ...
    <div class="container col-xxl-8 px-4 py-5 my-5">
      <div class="row flex-lg-row align-items-center g-5 py-5">
        ...
        <div class="col-lg-6 text-light">
          <h1 class="display-5 fw-bold lh-1 mb-3 text-light">Descarga tus series para verlas offline</h1>
          <p class="lead fw-semibold">Guarda tu contenido favorito y tendrás siempre algo para ver.</p>
...
.video-container .poster-image {
  ...
  height: auto;
  z-index: 1;
  /* Asegúrate de que la imagen esté sobre el video */
}
</style>